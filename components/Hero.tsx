...
const Hero = () => {
  return (
    <div className='pb-20 pt-36'>
      <div>
        <Spotlight fill='white' className='-top-40 -left-10 
        md:-left-32 md:-top-20 h-screen' />
        <Spotlight fill='purple' className='top-10 left-full h-[80vh]' />
    ...
    <div className='flex justify-center relative my-20 z-10'>
      <div className='max-w-[80vw] md:max-w-2xl 
      ...
      <TextGenerateEffect
        ...
        />
          ...
          <p className="text-center md:tracking-wider mb-4 text-md md:text-lg lg:text-2xl">
            Hi! I&apos;m Ali, a Modern Web Developer From Egypt.
          </p>

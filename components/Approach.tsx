  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] group-hover/canvas-card:opacity-0 
      ...
      <h2 className="text-sm dark:text-white opacity-0 group-hover/canvas-card:opacity-100 
      relative z-10 text-black mt-4  font-bold group-hover/canvas-card:text-white 
      group-hover/canvas-card:-translate-y-2 transition duration-200 text-center"
      style={{ color: "#c4ecff" }}
      >
...
const AceternityIcon = ( {order}: {order: string} ) => {
  return (
    <div>
      ...
      <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg bg-slate-950 px-10 py-2 text-sm font-medium text-white backdrop-blur-3xl">
      { order }
      </span> 
    </button>
    </div>
